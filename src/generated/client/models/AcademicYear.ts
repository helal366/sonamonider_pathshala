...
export type AcademicYearScalarWhereWithAggregatesInput = {
  ...
  academic_year_id?: Prisma.StringWithAggregatesFilter<"AcademicYear"> | string
  ...
  updated_at?: Prisma.DateTimeWithAggregatesFilter<"AcademicYear"> | Date | string
}
...
export type AcademicYearOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"academic_year_id" | "academic_year_number" | "created_at" | "updated_at", ExtArgs["result"]["academicYear"]>
...
export interface AcademicYearDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `academic_year_id`
   * const academicYearWithAcademic_year_idOnly = await prisma.academicYear.findMany({ select: { academic_year_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AcademicYears and only return the `academic_year_id`
   * const academicYearWithAcademic_year_idOnly = await prisma.academicYear.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AcademicYears and only return the `academic_year_id`
   * const academicYearWithAcademic_year_idOnly = await prisma.academicYear.updateManyAndReturn({
   *   select: { academic_year_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AcademicYearFieldRefs {
  readonly academic_year_id: Prisma.FieldRef<"AcademicYear", 'String'>
